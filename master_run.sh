...
sbatch --nodes=1 distributed_cpu_run.sh 500 4
sbatch --nodes=1 distributed_cpu_run.sh 500 8
sbatch --nodes=1 distributed_cpu_run.sh 500 16

sbatch --nodes=1 distributed_cpu_run.sh 1000 4
sbatch --nodes=1 distributed_cpu_run.sh 1000 8
sbatch --nodes=1 distributed_cpu_run.sh 1000 16

sbatch --nodes=1 distributed_cpu_run.sh 2000 4
sbatch --nodes=1 distributed_cpu_run.sh 2000 8
sbatch --nodes=1 distributed_cpu_run.sh 2000 16
